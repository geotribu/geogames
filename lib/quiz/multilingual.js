...
Quiz.meldungen = {
	...
	fr : {
		pruefen : 'Tu as rempli toute la grille, clique ici pour vérifier tes réponses!',
		lob1 : 'Bien jou\u00e9!',
		lob2 : 'Pas mal!',
		lob3 : 'Tu dois être plus assidu sur les revues de presse!',
		ergebnis1 : 'Tu as réussi du premier coup.',
		ergebnis2 : 'Tu as trouv\u00e9 apr\u00e8s deux tentatives seulement!',
		ergebnis3 : 'Tu as trouv\u00e9 apr\u00e8s %n tentatives.',
		// memo-quiz - Es können auch Triplets, Quartette und mehr gefunden werden müssen
		alleGefunden : 'Tu as trouv\u00e9 tous les "sets".',
		erneut : 'Clique ici pour recommencer',
		// Multiple-Choice-Quiz
		...
		waagrecht : 'Horizontal',
		eintragen : 'Valider',
		eingabehinweis : 'Utilisez le clavier pour inscrire des lettres dans les cases.',
		// Buchstabenraten-Quiz
		eingabehinweis_buchstabenraten : 'Utilisez le clavier pour inscrire des lettres dans les cases.',
		quizStarten : 'Clique ici pour lancer le jeu.',
